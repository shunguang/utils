...
fileNames{2} = 'simulationResults\IMT500_S4_w_cons.mat' ;
fileNames{3} = 'simulationResults\IMT500_S1_wo_cons.mat' ;
fileNames{4} = 'simulationResults\IMT500_S4_wo_cons.mat' ;
fileNames{5} = 'simulationResults\PDA_S1_wo_cons.mat' ;
...
%            xlabel('(g)');
    ...
    if j==1
            ...
            plot(original(1),original(2), 'bo')
    elseif j==2
            plot(Lx, Ly(:,1), 'rp-');   
            text(Lx(2,1)+50, Ly(2,1), 'k=1000') ;    
            plot(Lx, Ly(:,2), 'rd-');        
            text(Lx(2,1)+50, Ly(2,2), 'k=3000') ;    
            plot(Lx, Ly(:,3), 'rx-');        
            text(Lx(2,1)+50, Ly(2,3), 'k=5000') ;    
            plot(Lx, Ly(:,4), 'rs-');        
            text(Lx(2,1)+50, Ly(2,4), 'k=7000') ;    
    elseif j>2
        imshow(I);
